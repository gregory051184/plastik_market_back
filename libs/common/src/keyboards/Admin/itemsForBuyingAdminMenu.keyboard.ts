...
export const itemsForBuyingAdminMenuKeyboard: any = {
    reply_markup: {
        keyboard: [
            ...
            [{text: adminButtons.buyItems.itemCategories, callback_data: adminCallback.buyItems.itemCategories}],
            [{text: adminButtons.cities.getItemsByCityForBuying, callback_data: adminCallback.cities.getItemsByCityForBuying}],
            [{text: adminButtons.buyItems.findByTitle, callback_data: adminCallback.buyItems.findByTitle}],
            [{text: adminButtons.buyItems.getItemsByPrice, callback_data: adminCallback.buyItems.getItemsByPrice}],
            [{text: adminButtons.buyItems.cancel, callback_data: adminCallback.buyItems.cancel}]
        ],
