...
export const advertisementAdminMenuKeyboard: any = {
  reply_markup: {
    keyboard: [
      [
        {
          text: adminButtons.advertisement.createAdvertisement,
          web_app: { url: urls.create_new_advertisement_form },
        },
      ],
      [
        {
      ...
      [
        {
          text: adminButtons.advertisement.cancel,
          callback_data: adminCallback.advertisement.cancel,
        },
      ],
    ],
