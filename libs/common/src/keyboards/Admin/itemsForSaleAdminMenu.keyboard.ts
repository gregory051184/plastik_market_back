...
export const itemsForSaleAdminMenuKeyboard: any = {
    reply_markup: {
        keyboard: [
            ...
            [{text: adminButtons.saleItems.itemCategories, callback_data: adminCallback.saleItems.itemCategories}],
            [{text: adminButtons.cities.getItemsByCityForSale, callback_data: adminCallback.cities.getItemsByCityForSale}],
            [{text: adminButtons.saleItems.findByTitle, callback_data: adminCallback.saleItems.findByTitle}],
            [{text: adminButtons.saleItems.getItemsByPrice, callback_data: adminCallback.saleItems.getItemsByPrice}],
            [{text: adminButtons.saleItems.cancel, callback_data: adminCallback.saleItems.cancel}]
        ],
