...
export const mainAdminMenuKeyboard = async (chatId: string) => {
    return {
        reply_markup: {
            keyboard: [
                [{text: adminButtons.mainMenu.createItem, web_app: {url: urls.create_new_item_form + `/${chatId}`}}],
                //[{text: adminButtons.mainMenu.itemsFilter, web_app: {url: urls.items_filter}}]
                [{text: adminButtons.mainMenu.itemSubCategories, callback_data: adminCallback.mainMenu.itemSubCategories}],
                [{text: adminButtons.mainMenu.itemsFilter, callback_data: adminCallback.mainMenu.itemsFilter}],
                ...
                [{text: adminButtons.mainMenu.subscribe, callback_data: adminCallback.mainMenu.subscribe}]
            ],
